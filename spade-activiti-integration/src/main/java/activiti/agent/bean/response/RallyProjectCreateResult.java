...
@JsonPropertyOrder({ "_rallyAPIMajor", "_rallyAPIMinor", "Errors", "Warnings", "Object" })
public class RallyProjectCreateResult {
	...
	@JsonProperty("Object")
	private activiti.agent.bean.response.RallyProjectCreateObj object;
	@JsonIgnore
	...
	@JsonProperty("Object")
	public activiti.agent.bean.response.RallyProjectCreateObj getObject() {
		return object;
	}

	@JsonProperty("Object")
	public void setObject(activiti.agent.bean.response.RallyProjectCreateObj object) {
		this.object = object;
	}
